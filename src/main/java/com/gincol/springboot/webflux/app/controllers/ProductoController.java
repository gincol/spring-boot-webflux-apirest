package com.gincol.springboot.webflux.app.controllers;
...
public class ProductoController {
	...
	//Creación completa, con upload de fichero
	@PostMapping("/v2")
...
//	Alternativa sin envío de @PathVariable
//	@PutMapping()
//	public Mono<ResponseEntity<Producto>> editar(@RequestBody Producto producto){
//		return service.findById(producto.getId()).flatMap(p -> {
//			p.setNombre(producto.getNombre());
//			p.setPrecio(producto.getPrecio());
//			p.setCategoria(producto.getCategoria());
//			return service.save(p);
